    ...
    if (platform === 'gemini') {
        ...
        if (await fileInput.count() > 0) {
            try {
               ...
               appLog("[Playwright] Uploaded file via input[type=file].");
        ...
        if (isUploadClicked) {
          ...
          await page.waitForTimeout(3000); // Give Labs time to process upload
          ...
          if (await addBtn.isVisible()) {
             ...
             appLog("[Playwright] 'Thêm vào câu lệnh' button not found after upload.");
          }
        } else {
